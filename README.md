...
- **[BCM SDK Diagnostic Shell](docs/04_bcm_sdk_diag_shell.md):** Accessing the Broadcom SDK diagnostic shell inside the syncd container — architecture, port naming, SerDes diagnostics, eye scans, counters, and debugging workflows.
